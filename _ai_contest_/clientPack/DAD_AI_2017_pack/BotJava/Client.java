...
public class Client {
	...
	public static final char COMMAND_SEND_ACTION = 3;
	public static final char COMMAND_SEND_STAGE = 4;
	public static final char COMMAND_SEND_WINNER = 5;

	public static final char PLAYER_1 = 1;
	public static final char PLAYER_2 = 2;
	public static final char OBSERVER = 3;

	public static final char  ACTION_WAIT = 0;
	public static final char  ACTION_MOVE = 1;
	public static final char  ACTION_PICK = 2;
	public static final char  ACTION_PUT = 3;
	...
	public static final int BLOCK_PLAYER_2 = 2;
	public static final int BLOCK_PLAYER_12 = 3;
	public static final int BLOCK_OBSTACLE_SOFT = 4;
	public static final int BLOCK_OBSTACLE_HARD = 5;
	...
	// If it's your turn, remember to call AI_DoAction() with a valid move before the time is run out.
	// Please check for provided APIs in Javadoc/index.html
	public void AI_Update() {
		int[][] board = AI.getInstance().getBoard();	// Access block at (x, y) by using board[x][y]
		Position myPos = AI.getInstance().getMyInfos().getPosition();
		Position enemyPos = AI.getInstance().getEnemyInfos().getPosition();
		...
		if (size > 0) {
			...
			LOG("Action >>" + (int)ACTION_MOVE + " >> " + (int)direction + "\n");
